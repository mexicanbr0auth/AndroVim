...
object ToolCatalog {
    val ALL = listOf(
        ...
        ToolPackage("pyright", "Pyright (LSP Python)", "Language server Python, embutido no app."),
        ToolPackage("vscode-langservers-extracted", "LSP HTML/CSS/JSON", "Servers HTML, CSS e JSON do VS Code, embutidos no app."),
        ToolPackage("typescript-language-server", "LSP TypeScript/JS", "Language server TS/JS com tsserver, embutido no app."),
